...
<table width="50%" border="1" align="center" bordercolor="#FFFFFF" bgcolor="#FFFFFF" class="noneB">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><span class="style26">Add Music</span></td>
    <td><span class="style26">Edit Music</span></td>
    <td><span class="style26">Remove Music</span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<!--  <tr>
    <td colspan="4" class="unnamed1"><span class="style2">Users</span></td>
   
  </tr>
  <tr>
	  <td>&nbsp;</td>
    <td><span class="style25"><a href="addusers.php" class="links" >Add Users</a> </span></td>
    <td><span class="style25"><a href="editusers.php" class="links" >Edit/Remove Users</a> </span></td>
...
<!--  <tr>
    <td colspan="4" class="unnamed1"><span class="style2">Menus (Links)</span></td>
    
  </tr>
	 <tr>
	  <td> &nbsp;</td>
    <td ><span class="style25"><a href="addCategory.php" class="links" >Add Categories</a> </span></td>
    <td><span class="style25"><a href="EditCategories.php" class="links" >Edit Categories</a> </span></td>
